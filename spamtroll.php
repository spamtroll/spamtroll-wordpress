 ...
 * @return void
 */
function spamtroll_init_plugin() {
 ...
 * @return void
 */
function spamtroll_load_textdomain() {
 ...
 * @return void
 */
function spamtroll_do_cleanup_logs() {
	$settings       = get_option( 'spamtroll_settings', array() );
	$retention_days = isset( $settings['log_retention_days'] ) ? absint( $settings['log_retention_days'] ) : 30;
	Spamtroll_Logger::cleanup( $retention_days );
}
